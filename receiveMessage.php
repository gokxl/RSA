...
if (
    ...
    if ($connection == "local") {
        ...
        $t_receiver = "$database.user";
    }

    try {
        $db = new PDO("mysql:host=$host", $user, $password, $options);
        //echo "Database connected successfully <BR>";
        $sql_select = "Select * from $t_receiver where user_username = '$uid' and user_password = '$pwd'";
        $user_mob = $db->query("Select user_mobileNumber from $t_receiver where user_userName = '$user_id'")->fetch()['user_mobileNumber'];
                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a href="./receiveMessage1.php?user_mob_rm1=<?php echo $user_mob; ?>" class="nav-link" href="receiveMessage1.php">Generate Key</a>
                                </li>
                                <li class="nav-item">
                                    <a href="./receiveMessageA.php?user_mob_rmA=<?php echo $user_mob; ?>" class="nav-link" href="receiveMessageA.php">See Messages</a>
                                </li>
                            </ul>
                        </nav>
