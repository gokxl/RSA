        ...
        <div class="col-sm-8">
            ...
            <div class="container-sm" style="Width:40%">
                ...
                <div class="login-form">
                    ...
                    <form action="./Bpython/RsaPublicKeyDist.py" method="post" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" id="user_mob_rmpy" name="user_mob_rmpy" value=<?php echo $user_mob; ?> />
                        <div class="row justify-content-center ">
                            <input class="form-group bg-primary text-white" type="submit" name="PublicPrivscript" value="Click to Generate Key" />
                        </div>
                    </form>
                </div>
